    ...
    <DashboardGuard>
      <div className="container mx-auto py-6 space-y-6">        {/* Header */}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold tracking-tight">
                  {companyProfile?.displayName || companyProfile?.name || 'Company Profile'}
                </h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                    ...
                    <div className="w-full space-y-3 text-sm">
                      ...
                      {companyProfile.size && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-muted-foreground">
                            {COMPANY_SIZES.find(s => s.value === companyProfile.size)?.label || companyProfile.size}
                          </span>
                        </div>
                      )}
                      {companyProfile.createdAt && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-muted-foreground">
                            Founded {new Date(companyProfile.createdAt).getFullYear()}
                          </span>
                        </div>
                      )}
                    </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="display-name"
                        value={editData.displayName ?? companyProfile.displayName ?? ''}
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={editData.size ?? companyProfile.size} onValueChange={(value) => handleInputChange('size', value)}>
                        <SelectTrigger className="h-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={editData.businessType ?? companyProfile.businessType} onValueChange={(value) => handleInputChange('businessType', value)}>
                          <SelectTrigger className="h-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={editData.registrationNumber ?? companyProfile.registrationNumber ?? ''}
          ...
          </TabsContent>          <TabsContent value="team" className="space-y-6">
            {loading ? (
              <TeamMembersSkeleton />
            ) : (
              <Card>
                ...
                <CardContent>
                  {teamMembers.length > 0 ? (
                          ...
                          <div className="flex items-center space-x-4">
                            <div className="relative">
                              <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center ring-2 ring-white">
                                {member.avatar ? (
                                  <Image src={member.avatar} alt="" width={48} height={48} className="rounded-full" />
                                ) : (
                              ...
                              {member.type === 'user' && member.status === 'ACTIVE' && (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 mb-6">Start building your team by inviting members to join your company.</p>
                      {(isOwner || ['ADMIN', 'MANAGER'].includes(userRole || '')) && (
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Manage your company locations and employee access assignments
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">User Location Assignments</h3>
                    <p className="text-sm text-muted-foreground">
