...
export async function POST(request: NextRequest) {
  try {
    ...
    const productData = {
      ...
      sellingPrice: body.sellingPrice ? parseFloat(body.sellingPrice.toString()) : undefined,
      wholesalePrice: body.wholesalePrice ? parseFloat(body.wholesalePrice.toString()) : undefined,
