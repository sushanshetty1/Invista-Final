...
const LOCATION_TYPES = [
  ...
  { value: 'DISTRIBUTION_CENTER', label: 'Distribution Center', icon: Warehouse },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Company Locations</h2>
          <p className="text-muted-foreground">
            Manage warehouses, retail outlets, and offices across your organization
          </p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new warehouse, retail outlet, or office location to your company
              </DialogDescription>
            </DialogHeader>
            <LocationForm 
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {location.allowsReturns && (
                    <Badge variant="secondary" className="text-xs">Returns</Badge>
                  )}
                  {location.allowsTransfers && (
                    <Badge variant="secondary" className="text-xs">Transfers</Badge>
                  )}
                </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-600 mb-4">
              Start by adding your first warehouse, retail outlet, or office location
            </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Can store and manage inventory</p>
              </div>
              <Switch
                checked={formData.allowsInventory}
                onCheckedChange={(checked) => setFormData({ ...formData, allowsInventory: checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Can process customer orders</p>
              </div>
              <Switch
                checked={formData.allowsOrders}
                onCheckedChange={(checked) => setFormData({ ...formData, allowsOrders: checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Can handle product returns</p>
              </div>
              <Switch
                checked={formData.allowsReturns}
                onCheckedChange={(checked) => setFormData({ ...formData, allowsReturns: checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Can participate in stock transfers</p>
              </div>
              <Switch
                checked={formData.allowsTransfers}
                onCheckedChange={(checked) => setFormData({ ...formData, allowsTransfers: checked })}
              />
            </div>
