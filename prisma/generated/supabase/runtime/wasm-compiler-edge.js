...
var ct,
	...
	Uo = fe(() => {
		...
		S.logarithm = S.log = function (e) {
			...
			return this.eq(ge)
				? new n(0)
				: ((G = !1), (t = De(qt(this, o), qt(e, o), o)), (G = !0), $(t, i));
		};
		S.minus = S.sub = function (e) {
			return (
				(e = new this.constructor(e)),
				this.s == e.s ? No(this, e) : _o(this, ((e.s = -e.s), e))
			);
		};
		S.modulo = S.mod = function (e) {
			...
			return this.s
				? ((G = !1), (t = De(this, e, 0, 1).times(e)), (G = !0), this.minus(t))
				: $(new n(this), i);
		};
		...
		S.plus = S.add = function (e) {
			return (
				(e = new this.constructor(e)),
				this.s == e.s ? _o(this, e) : No(this, ((e.s = -e.s), e))
			);
		};
		...
		S.squareRoot = S.sqrt = function () {
			...
			for (
				...
				if (
					((o = n),
					(n = o.plus(De(this, o, s + 2)).times(0.5)),
...
function Si(e, t, r, n, i, o) {
	const d = e._runtimeDataModel.models[t].fields.reduce(
		(f, T) => ({ ...f, [T.name]: T }),
		{},
	);
	return (f) => {
